...
generate_birth_counts <- function(total_births,
                                  birth_dates, delta) {
  returns(birth_counts)
}

do_simiulation <- function (birth_counts, # as a function
                    incidence, # as a function
                    base_mortality, # as a function
                    excess_mortality, # as a function
                    age_max, # as a value, age min is set to 0
                    time_steps, # as a value
