...
#' @return Returns a vector of bithcounts  from the inputs \code{total_births},\code{delta}, and \code{birth_dates} of length \code(max(birth_dates):min(birth_dates))
#' @examples
