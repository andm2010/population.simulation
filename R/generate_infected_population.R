...
#' @param  infected_mortality_array a survival probability matrix for the infected a 3 dimensional structure of age, time and tau(time since infection)
...
generate_infected_population  <- function(infected_mortality_array,
                                          infected_pop_counts)
  {
  ...
  for (aa in ages){
    ...
    for ( ta  in  Tau){
      ...
      infected[times, aa , ta] = infected_mortality_array [times - 1, aa - 1, ta -1] * infected[times - 1 , aa - 1, ta - 1]
